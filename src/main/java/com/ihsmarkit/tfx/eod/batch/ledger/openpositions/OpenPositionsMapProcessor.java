...
public class OpenPositionsMapProcessor implements ItemProcessor<OpenPositionsItem, OpenPositionsWriteItem> {
    ...
    public OpenPositionsWriteItem process(final OpenPositionsItem openPositionsItem) {
        ...
        return OpenPositionsWriteItem.builder()
            ...
            .shortPositionPreviousDay(formatBigDecimal(openPositionsItem.getShortPositionPreviousDay()))
            .longPositionPreviousDay(formatBigDecimal(openPositionsItem.getLongPositionPreviousDay()))
            .buyTradingAmount(formatBigDecimal(openPositionsItem.getBuyTradingAmount()))
            .sellTradingAmount(formatBigDecimal(openPositionsItem.getSellTradingAmount()))
            .shortPosition(formatBigDecimal(openPositionsItem.getShortPosition()))
            .longPosition(formatBigDecimal(openPositionsItem.getLongPosition()))
            .initialMtmAmount(formatBigDecimal(openPositionsItem.getInitialMtmAmount()))
            .dailyMtmAmount(formatBigDecimal(openPositionsItem.getDailyMtmAmount()))
            .swapPoint(formatBigDecimal(openPositionsItem.getSwapPoint()))
            .totalVariationMargin(formatBigDecimal(openPositionsItem.getTotalVariationMargin()))
    ...
    public List<OpenPositionsWriteItem> mapToTfxTotal(final Map<String, OpenPositionsTfxTotal> tfxTotals) {
        return EntryStream.of(tfxTotals).mapKeyValue((currencyPairCode, total) ->
            OpenPositionsWriteItem.builder()
                ...
                .tradeDate(formatDate(businessDate))
                .shortPositionPreviousDay(formatBigDecimal(total.getShortPositionPreviousDay()))
                .longPositionPreviousDay(formatBigDecimal(total.getLongPositionPreviousDay()))
                .buyTradingAmount(formatBigDecimal(total.getBuyTradingAmount()))
                .sellTradingAmount(formatBigDecimal(total.getSellTradingAmount()))
                .shortPosition(formatBigDecimal(total.getShortPosition()))
                .longPosition(formatBigDecimal(total.getLongPosition()))
