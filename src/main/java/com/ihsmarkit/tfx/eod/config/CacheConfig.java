...
public class CacheConfig extends CachingConfigurerSupport {
    ...
    public static final String DSP_CACHE = "dspCache";
    public static final String JPY_RATES_CACHE = "joyRatesCache";
    public static final String SWAP_POINT_CACHE = "dspCache";

    @Bean
    @JobScope
    public CacheManager jobCacheManager() {
        return new ConcurrentMapCacheManager(TRADE_DATES_CACHE, VALUE_DATES_CACHE, DSP_CACHE, JPY_RATES_CACHE, SWAP_POINT_CACHE);
    }
