...
class MarkToMarketTradeMapperTest {
    ...
    void shouldConvertToEodProductCashSettlementEntity() {
        ...
        final LocalDate businessDate = LocalDate.of(2019, 11, 05);
        ...
        assertThat(eod.getAmount().getCurrency()).isEqualTo("JPY");
        ...
        assertThat(eod.getSettlementDate()).isEqualTo(businessDate.plusDays(3));
